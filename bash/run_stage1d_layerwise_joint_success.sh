...
# Layerwise Clean0-vs-BadNet0 analysis using the previous pixel-space
# BadNet joint-PGD-success cohort.  This is a separate comparison protocol;
# it does not train a Probe or rerun PGD.
set -euo pipefail
...
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_ROOT}/results/stage1d_layerwise_joint_success}"
GPU_ID="${GPU_ID:-0}"
...
{
    echo "[$(date --iso-8601=seconds)] Stage 1D joint-success layerwise mechanism analysis"
